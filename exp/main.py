...
from train import incremental_testing, patch_training

def main():    
    
    args = set_arguments()
    print(f'''
        standalone patch dataset to train large vocab_size {args.vocab_size}, patch_size {args.patch_size}
        ...
    ''')
    ...
    patch_training(args, iptresnet, train_loader, test_loader)
