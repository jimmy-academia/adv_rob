...
def set_arguments():
    ...
    parser.add_argument('--train_epochs', type=int, default=5, help='classifier training epochs')
    ...
    args.tokenizer_path = args.ckpt_dir/f'tokenizer_{args.dataset}_{args.patch_size}_{args.vocab_size}_{args.toktrain_epochs}.pth'
    args.classifier_path = args.ckpt_dir/f'classifier_{args.dataset}_{args.patch_size}_{args.vocab_size}.pth'
    return args
