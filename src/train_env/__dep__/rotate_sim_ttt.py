...
'''
incorporate test time training into AST: rotate patch with rotation!!
'''

class AdversarialSimilarity_TestTimeRotation_Trainer(Base_trainer):
    # def train(self):
    ...
    #         self.test_correct, self.adv_correct, self.test_total = test_attack(self.args, self.model, self.test_loader, pgd_attack)
    #         self.append_record()    
