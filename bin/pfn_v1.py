...
class PFN_v1(nn.Module):
    """docstring for PFN_v1"""
    def __init__(self):
        super(PFN_v1, self).__init__()
        self.flatten = nn.Flatten()
        self.fc1 = nn.Linear(28 * 28, 128)
        self.relu = nn.ReLU()
        self.fc2 = nn.Linear(128, 10)

        self.protos = nn.Embedding(16, 128)
        self.tau = 0.1
...
def main():
    print('make a prototypical features network and check adversarial property')
