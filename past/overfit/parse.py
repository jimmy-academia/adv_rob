...
def set_arguments():
    ...
    parser.add_argument('--vocabulary_size', type=int, default=2048, help='vocabulary size of token')
    ...
    parser.add_argument('--train_epochs', type=int, default=1280, help='classifier training epochs')
