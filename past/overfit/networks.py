...
class IPTResnet(nn.Module):
    def __init__(self, args):
        ...
        self.args = args
        self.tokenizer = Tokenizer(args.patch_size, args.vocabulary_size, args.num_hidden_layer)
        self.embedding = nn.Embedding(args.vocabulary_size, args.patch_size)
        self.classifier = get_resnet_model(num_classes=args.vocabulary_size, channels=args.input_channels)
