...
class AlternateSimilarityTrainer(Base_trainer):
    def train(self):
        ...
        optimizer_pred = torch.optim.Adam(self.model.iptnet.predictor.parameters())
        ...
        for self.epoch in range(1, self.num_epochs+1):
            ...
            for step in dual_steps:
                ...
                self.model.iptnet.predictor.requires_grad_(step == "predictor")
