...
class Avg_fineadjustTrainer(Base_trainer):
    def train(self):
        ...
        optimizer_pred = torch.optim.Adam(list(self.model.iptnet.base_predictor.parameters()) + list(self.model.iptnet.pat_predictor.parameters()))
        ...
        print()
        print('....todo: adjust loss method split avg vs pattern!!....')
        print()
        ...
        for self.epoch in range(1, self.num_epochs+1):
            ...
            for step in dual_steps:
                ...
                self.model.iptnet.base_predictor.requires_grad_(step == "predictor")
                self.model.iptnet.pat_predictor.requires_grad_(step == "predictor")
